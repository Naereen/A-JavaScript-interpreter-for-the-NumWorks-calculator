...
static __attribute__ ((gnu_inline)) inline bool jsvArrayIsEmpty(JsVar *arr) { do { } while(0); return !jsvGetFirstChild(arr); }
  ...
  while (*fmt) {
    if (*fmt == '%') {
      ...
      case '9':
      {
        ...
        else { do { } while(0); itostr(v, buf, 10); }
        fmt++;
  ...
  if (expressionOnly) {
    ...
    if (lex->tk==LEX_STR) {
      ...
      if (jsvIsStringEqual(tokenValue, "compiled")) {
        ...
        if (lex->tk==';') { do { } while(0);jslGetNextToken(); };
...
__attribute__ ((noinline)) JsVar *jspeClassDefinition(bool parseNamedClass) {
  ...
  while ((lex->tk==LEX_ID || lex->tk==LEX_R_STATIC) && !jspIsInterrupted()) {
    ...
    if (isStatic) { do { } while(0);jslGetNextToken(); };
    ...
    while (lex->tk==';') { do { } while(0);jslGetNextToken(); };
    jsvUnLock(funcName);
  }
...
static const JswSymPtr jswSymbols_Eadk[] = {
  ...
  { 226, JSWAT_BOOL, (void*)jswrap_display_wait_for_vblank},
  { 250, JSWAT_INT32, (void*)jswrap_random},
  { 257, JSWAT_INT32, (void*)jswrap_timing_millis},
  { 271, JSWAT_VOID | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_timing_msleep},
  { 285, JSWAT_VOID | (JSWAT_INT32 << ((((JSWAT_MASK+1)== 1)? 0: ((JSWAT_MASK+1)== 2)? 1: ((JSWAT_MASK+1)== 4)? 2: ((JSWAT_MASK+1)== 8)? 3: ((JSWAT_MASK+1)== 16)? 4: ((JSWAT_MASK+1)== 32)? 5: ((JSWAT_MASK+1)== 64)? 6: ((JSWAT_MASK+1)== 128)? 7: ((JSWAT_MASK+1)== 256)? 8: ((JSWAT_MASK+1)== 512)? 9: ((JSWAT_MASK+1)== 1024)?10: ((JSWAT_MASK+1)== 2048)?11: ((JSWAT_MASK+1)== 4096)?12: ((JSWAT_MASK+1)== 8192)?13: ((JSWAT_MASK+1)==16384)?14: ((JSWAT_MASK+1)==32768)?15:10000 )*1)), (void*)jswrap_timing_usleep},
  { 299, JSWAT_BOOL, (void*)jswrap_usb_is_plugged}
};
...
const JswSymList jswSymbolTables[] = {
  {jswSymbols_Eadk, jswSymbols_Eadk_str, 20},
...
void jswrap_display_push_rect_uniform(JsVar *args) {
    ...
    uint16_t color = (uint16_t) eadk_color_black;
